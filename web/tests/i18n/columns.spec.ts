...
test.describe('Table Columns i18n', () => {
  test('columns page has zero [intlify] warnings in zh-CN and en', async ({ authenticatedPage }) => {
    const { page } = authenticatedPage;

    await page.goto('http://localhost:8080/#/columns');
