...
test.describe('IP Whitelist i18n', () => {
  test('whitelist page has zero [intlify] warnings in zh-CN and en', async ({ authenticatedPage }) => {
    const { page } = authenticatedPage;

    await page.goto('http://localhost:8080/#/whitelist');
