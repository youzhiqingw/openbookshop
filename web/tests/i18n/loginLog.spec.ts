...
test.describe('Login Log i18n', () => {
  test('loginLog page has zero [intlify] warnings in zh-CN and en', async ({ authenticatedPage }) => {
    const { page } = authenticatedPage;

    await page.goto('http://localhost:8080/#/loginLog');
