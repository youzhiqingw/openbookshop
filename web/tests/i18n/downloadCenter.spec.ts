...
test.describe('Download Center i18n', () => {
  test('downloadCenter page has zero [intlify] warnings in zh-CN and en', async ({ authenticatedPage }) => {
    const { page } = authenticatedPage;

    await page.goto('http://localhost:8080/#/downloadCenter');
