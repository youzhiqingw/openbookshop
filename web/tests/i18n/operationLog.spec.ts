...
test.describe('Operation Log i18n', () => {
  test('operationLog page has zero [intlify] warnings in zh-CN and en', async ({ authenticatedPage }) => {
    const { page } = authenticatedPage;

    await page.goto('http://localhost:8080/#/operationLog');
