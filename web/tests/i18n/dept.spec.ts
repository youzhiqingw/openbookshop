...
test.describe('Department Management i18n', () => {
  test('dept page has zero [intlify] warnings in zh-CN and en', async ({ authenticatedPage }) => {
    const { page } = authenticatedPage;

    await page.goto('http://localhost:8080/#/dept');
