...
class Order(models.Model):
    ...
    order_no = models.CharField(
        "订单号", max_length=50, unique=True, default=generate_order_no
    )
    status = models.CharField(
        "状态", max_length=20, choices=STATUS_CHOICES, default="pending_payment"
    )
    ...
    payment_method = models.CharField(
        "支付方式", max_length=20, choices=PAYMENT_METHOD_CHOICES, blank=True
    )
