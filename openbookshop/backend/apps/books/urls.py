...
from .views import (
    ...
    AdminCategoryUpdateView, AdminLowStockView, BookDetailView, BookListView,
    CategoryListView, MerchantBookCreateView, MerchantBookListView,
    MerchantBookUpdateView, MerchantLowStockView,
)
