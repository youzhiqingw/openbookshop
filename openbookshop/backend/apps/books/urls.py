...
from .views import (
    ...
    BookReviewListView,
    CategoryListView,
    MerchantBookCreateView,
    MerchantBookListView,
    MerchantBookUpdateView,
    MerchantLowStockView,
    MerchantReviewListView,
    MerchantReviewReplyView,
)
...
urlpatterns = [
    ...
    path(
        ...
        name="book-review-create",
    ),
    # Merchant (string patterns first, then int)
    path("merchant/", MerchantBookListView.as_view(), name="merchant-book-list"),
    path(
        "merchant/create/",
        MerchantBookCreateView.as_view(),
        name="merchant-book-create",
    ),
    path(
        "merchant/low-stock/", MerchantLowStockView.as_view(), name="merchant-low-stock"
    ),
    path(
        "merchant/reviews/",
    ...
    path(
        "merchant/reviews/<int:pk>/reply/",
        MerchantReviewReplyView.as_view(),
        name="merchant-review-reply",
    ),
    path(
        "merchant/<int:pk>/",
        MerchantBookUpdateView.as_view(),
        name="merchant-book-update",
    ),
